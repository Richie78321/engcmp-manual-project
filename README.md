...
ReadMe and Licenses outline the rules of using the software. Many ReadMes have an overview of the software,
...
Fortunately, many great websites do this for you and contain a collective list 
